...
/// <summary>
/// Arguments for <see cref="DistributedApplicationBuilderExtensions.AddEdgeProject"/>.
/// </summary>
public record EdgeProjectOptions : IStackProjectOptions
{
    ...
    /// </summary>
    [SetsRequiredMembers]
    public EdgeProjectOptions(EdgeProjectOptions other)
    {
