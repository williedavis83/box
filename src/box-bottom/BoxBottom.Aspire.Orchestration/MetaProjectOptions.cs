...
/// <summary>
/// Arguments for <see cref="DistributedApplicationBuilderExtensions.AddMetaProject"/>.
/// </summary>
public record MetaProjectOptions : IStackProjectOptions
{
    ...
    /// </summary>
    [SetsRequiredMembers]
    public MetaProjectOptions(MetaProjectOptions other)
    {
